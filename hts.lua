...
-- Urutan CP fix (CP1 → CP5 → SUMMIT)
local checkpoints = {
    {"CP1", CFrame.new(168.964996, 325.432037, 376.070007)},
    {"CP2", CFrame.new(386.986053, 393.932037, 280.919952, 
        0.999988198, -3.017489196e-08, -0.00485849567, 
        3.04457117e-08, 1, 5.56674138e-08, 
        0.00485849567, -5.581467732e-08, 0.999988198)},
    {"CP3", CFrame.new(663.062195, 517.432007, 77.9546585, 
        0.997971058, -5.2473853e-10, -0.0636694878, 
        5.54794877e-10, 1, 4.5438886e-10, 
        0.0636694878, -4.88790397e-10, 0.997971058)},
    {"CP4", CFrame.new(447.947968, 733.432007, -262.273407, 
        0.999511242, -8.454063766e-08, -0.0312621221, 
        8.62469136e-08, 1, 5.323131456e-08, 
        0.0312621221, -5.590155896e-08, 0.999511242)},
    {"CP5", CFrame.new(71.9999695, 857.432007, -328.859985)},
    {"SUMMIT", CFrame.new(-657.939148, 1089.43201, 270.277374, 
        0.935168266, -1.00108551e-07, 0.354203761, 
        9.88319613e-08, 1, 2.16938378e-08, 
        -0.354203761, 1.471926236e-08, 0.935168266)}
}
...
statusLabel.Text = "Auto Summit: OFF | Loop: 0"
...
minimize.MouseButton1Click:Connect(function()
    ...
    main.Size = minimized and UDim2.new(0,220,0,30) or UDim2.new(0,220,0,350)
end)

-- Tombol CP sesuai urutan
local y = 40
...
autoBtn.MouseButton1Click:Connect(function()
    ...
    statusLabel.Text = "Auto Summit: "..(autoSummit and "ON" or "OFF").." | Loop: "..loopCount
